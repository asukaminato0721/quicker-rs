...
impl QuickerApp {
                                ...
                                .show(ui, |ui| {
                                    ...
                                    egui::ScrollArea::vertical()
                                        ...
                                        .show(ui, |ui| match self.settings_page {
                                            SettingsPage::Launcher => self
                                                .render_launcher_settings_page(ui, &current_process_label),
                                            SettingsPage::Profiles => self.render_profile_settings_page(
                                                ui,
                                                current_process_alias.as_deref(),
                                                &current_process_label,
                                            ),
                                            SettingsPage::Storage => self
                                                .render_storage_settings_page(ui, &current_process_label),
    ...
    fn render_launcher_settings_page(&mut self, ui: &mut egui::Ui, current_process_label: &str) {
        settings_card(
            ui,
            "Launcher Shortcut",
    ...
    fn render_storage_settings_page(&mut self, ui: &mut egui::Ui, current_process_label: &str) {
    ...
    fn render_about_settings_page(&mut self, ui: &mut egui::Ui) {
        settings_card(
            ui,
            "How This Page Works",
...
fn settings_badge(ui: &mut egui::Ui, text: impl Into<String>) {
    let text = text.into();
    egui::Frame::new()
